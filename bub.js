...
.attr("x", function (d, i) {
return (oR * (3 * (iB + 1) - 1) + oR * 1.5 * Math.cos((i - 1) * 45 / 310 * 3.1415926));
return (oR * (3 * (iB + 1) - 1) + oR * 1.5 * Math.cos((i - 1) * 45 / 310 * 3.1415926));
})
.attr("y", function (d, i) {
return ((h + oR) / 3 + oR * 1.5 * Math.sin((i - 1) * 45 / 310 * 3.1415926));
})
//  .style("display", 'none')
.attr("text-anchor", "middle")
...
let x = ((oR  * Math.cos(angle)))+Math.round(parentXValue); // Calculate the x position of the element.
let y = ((oR  * Math.sin(angle)))+Math.round(parentYValue); // Calculate the y position of the element.
